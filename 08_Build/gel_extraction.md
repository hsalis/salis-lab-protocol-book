...
When you have a heterogenous sample of DNA fragments of different lengths, you will do a gel extraction to separate the DNA pieces and purify the fragment\(s\) of interest. Follow [gel electrophoresis](/09_Test/gel_electro.md) guides when doing a gel extraction.
...
1. Make a 1% agarose gel using TAE. See `TAE Gel` under [Media Recipes](/recipes.md).
2. Add 5-10 µL of the appropriate ladder and DNA pre-mixed with loading dye to the extra-wide wells in the agarose gel.
...
20. Measure DNA concentration using the [NanoDrop](/11_Lab_Equipment/nanodrop.md).
